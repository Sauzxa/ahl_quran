...
class AttendanceStatsSelectionScreen extends StatefulWidget {
  const AttendanceStatsSelectionScreen({super.key});

  @override
  State<AttendanceStatsSelectionScreen> createState() =>
      _AttendanceStatsSelectionScreenState();
}

class _AttendanceStatsSelectionScreenState
    extends State<AttendanceStatsSelectionScreen> {
  ...
  Widget _buildSubmitButton() {
    return ElevatedButton(
      onPressed: () {
        ...
        // Navigate to attendance stats screen
        Get.toNamed(
          Routes.attendanceStats,
          parameters: {
