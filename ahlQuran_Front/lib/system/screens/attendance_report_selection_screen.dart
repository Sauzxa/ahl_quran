...
class AttendanceReportSelectionScreen extends StatefulWidget {
  const AttendanceReportSelectionScreen({super.key});

  @override
  State<AttendanceReportSelectionScreen> createState() =>
      _AttendanceReportSelectionScreenState();
}

class _AttendanceReportSelectionScreenState
    extends State<AttendanceReportSelectionScreen> {
  ...
  Widget _buildSubmitButton() {
    return ElevatedButton(
      onPressed: () {
        ...
        Get.toNamed(
          '/attendance-report?lectureId=${selectedLecture!.lectureId}&lectureName=${Uri.encodeComponent(selectedLecture!.lectureNameAr ?? '')}&startDate=${Uri.encodeComponent(startDateController.text)}&endDate=${Uri.encodeComponent(endDateController.text)}',
        );
      },
