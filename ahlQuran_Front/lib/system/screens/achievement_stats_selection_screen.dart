...
class AchievementStatsSelectionScreen extends StatefulWidget {
  const AchievementStatsSelectionScreen({super.key});

  @override
  State<AchievementStatsSelectionScreen> createState() =>
      _AchievementStatsSelectionScreenState();
}

class _AchievementStatsSelectionScreenState
    extends State<AchievementStatsSelectionScreen> {
  ...
  Widget _buildSubmitButton() {
    return ElevatedButton(
      onPressed: () {
        ...
        // Navigate to achievement stats screen using Get.toNamed with arguments
        Get.toNamed(
          Routes.achievementStats,
          parameters: {
