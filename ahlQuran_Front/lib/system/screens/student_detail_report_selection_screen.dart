...
class StudentDetailReportSelectionScreen extends StatefulWidget {
  const StudentDetailReportSelectionScreen({super.key});

  @override
  State<StudentDetailReportSelectionScreen> createState() =>
      _StudentDetailReportSelectionScreenState();
}

class _StudentDetailReportSelectionScreenState
    extends State<StudentDetailReportSelectionScreen> {
  ...
  Widget _buildSubmitButton() {
    return ElevatedButton(
      onPressed: () {
        ...
        Get.toNamed(
          '/student-detail-report?lectureId=${selectedLecture!.lectureId}&lectureName=${Uri.encodeComponent(selectedLecture!.lectureNameAr ?? '')}&studentId=${selectedStudent!.id}&studentName=${Uri.encodeComponent('${selectedStudent!.personalInfo.firstNameAr ?? ''} ${selectedStudent!.personalInfo.lastNameAr ?? ''}')}&date=${Uri.encodeComponent(dateController.text)}',
        );
      },
