...
class LectureStatsSelectionScreen extends StatefulWidget {
  const LectureStatsSelectionScreen({super.key});

  @override
  State<LectureStatsSelectionScreen> createState() =>
      _LectureStatsSelectionScreenState();
}

class _LectureStatsSelectionScreenState
    extends State<LectureStatsSelectionScreen> {
  ...
  Widget _buildSubmitButton() {
    return ElevatedButton(
      onPressed: () {
        ...
        // Navigate to lecture stats screen
        Get.toNamed(
          Routes.lectureStats,
          parameters: {
